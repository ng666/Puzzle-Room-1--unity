...
public class Spot_Light_Green : MonoBehaviour
{
    public bool player_casted = false;
    public bool gbox_covered = false;
    public bool glight_stopped = false;
    ...
    void Update()
    {
        ...
        {
            if (hit_2.collider.gameObject.CompareTag("box_green"))
                gbox_covered = false;
            else
                gbox_covered = true;
        }
